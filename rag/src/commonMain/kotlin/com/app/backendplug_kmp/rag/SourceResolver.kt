...
/**
    * The starter registry. Add entries here to make new datasets discoverable;
    * descriptions are what get matched, so phrase them in the user's terms.
*/
object DefaultSourceRegistry {
    val entries: List<SourceCandidate> = listOf(
        SourceCandidate(
            name = "USA Freeway System",
            description = "United States highways, freeways, and interstate routes",
    ...
    description = "Major United States cities with population figures",
    url = "https://sampleserver6.arcgisonline.com/arcgis/rest/services/USA/MapServer/0/query?where=1%3D1&outFields=*&returnGeometry=false&f=json"
    ),
    SourceCandidate(
    name = "Sample Blog Posts",
    description = "Sample blog posts and articles for testing",
